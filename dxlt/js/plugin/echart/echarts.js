...
define('zrender/zrender', [
    ...
    var theme = {
        ...
        textStyle: { fontFamily: 'Microsoft YaHei, Arial, Verdana, sans-serif' }
    };
    return theme;
        ...
        _markPoint: function (seriesIndex, mpOption) {
            ...
            if (!mpOption.large) {
                for (var i = 0, l = data.length; i < l; i++) {
                    ...
                    /* var divhtml = '<div class="maps-show clearfix" style="position:absolute; left:' +(data[i].x+220)+'px; top:'+(data[i].y-130)+'px;">' +
                     '<div class="mshow-top clearfix"><b class="fr">数量：20个</b><span>'+data[i].name+'</span></div>' +
                     '<div class="mshow-list clearfix">' +
                     '<div class="mshow-left fl"><ul>' +
                     '<li class="clearfix"><span class="fl">今日发电:</span><font class="fl">200 kwh</font></li>' +
                     '<li class="clearfix"><span class="fl">累计发电:</span><font class="fl">24 kwh</font></li>' +
                     '<li class="clearfix"><span class="fl">当前功率:</span><font class="fl">239 瓦</font></li>' +
                     '</ul></div><div class="mshow-right fr"><img src="images/img2.png"></div></div></div>';
                     $("#main").append(divhtml);*/
                    ...
                    //gonghm 自定义markpoint图标尺寸
                    itemShape.style.height=mpOption.symbolHeight;
                    itemShape.style.width=mpOption.symbolWidth;
                    itemShape.style.y = itemShape.style.y -40;
                    itemShape.style.x = itemShape.style.x -10;
